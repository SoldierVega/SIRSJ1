        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <center><h3 class="page-header">Reporte Rechazos</h3>
                                ...
                                <div class="panel-group" id="accordion">
                                    <div class="panel panel-green">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <form id="addVenta" method="POST"action="<?php echo site_url('/Reportes/rechazos/rechazo/') ?>">
                                        ...
                                        <div class="panel panel-green">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    <form id="addVenta" method="POST"action="<?php echo base_url() . "/Reportes/rechazos/rechazoF/"; ?>">
                                                        <div class="form-group">
                                                             <table>
                                                                 <tr>
