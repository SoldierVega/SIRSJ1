        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <center><h3 class="page-header">Defectos </h3>
                                ...
                                <div class="panel-group" id="accordion">
                                    <div class="panel panel-green">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <form id="addVenta" method="POST"action="<?php echo site_url('/Reportes/defectos/defecto/') ?>">
                                    ...
                                    <div class="panel panel-green">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapsefive">Reporte Fechas</a>
                                            </h4>
                                        </div>
                                        <div id="collapsefive" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <form id="addVenta" method="POST"action="<?php echo base_url() . "/Reportes/defectos/defectoF/"; ?>">
                                                    <div class="form-group">
                                                         <table>
                                                             <tr>
