        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <center><h3 class="page-header">Reporte Tiempos Muertos </h3>
                            ...
                            <div class="panel-body">
                                <div class="panel-group" id="accordion">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <form id="addVenta" method="POST"action="<?php echo site_url('/Reportes/tiemposMuertos/reporteTM/') ?>">
                                ...
                                <div class="panel panel-green">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <form id="addVenta" method="POST"action="<?php echo base_url() . "Reportes/tiemposMuertosF/reporteTMF/"; ?>">
                               <div class="form-group">
                                    <table>
                                        <tr>
