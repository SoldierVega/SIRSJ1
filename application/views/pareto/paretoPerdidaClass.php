<?php
	...
	require('db_config.php');
        ...
        $fecha=date('Y/m/d',strtotime('-8 day'));
         ...
         //********************Pareto 1er Turno******************************************
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.turno = 1 and t.tipo = 'Perdida' and c.fecha='{$fecha}'
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
         ...
         //********************Pareto 2do Turno******************************************
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.turno = 2 and t.tipo = 'Perdida' and c.fecha='{$fecha}'
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
         ...
         //********************Pareto 3er Turno******************************************
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.turno = 3 and t.tipo = 'Perdida' and c.fecha='{$fecha}'
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
