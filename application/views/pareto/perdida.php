<?php
require 'paretoPerdidaClass.php';

if(empty($datosP)){
                  $msg=('<div class="alert alert-warning"><strong>Datos Obtenidos!'
                    . '</strong> del Día '.$fecha.'.</div>');
                } else {
                  $msg=('<div class="alert alert-info">'
                    . '<strong>Datos Obtenidos!</strong> del Día '.$fecha.'.</div>');
                }
?>
