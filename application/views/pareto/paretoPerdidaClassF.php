        ...
        if($linea == 0){
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.turno = 1 and t.tipo = 'Perdida' and c.fecha BETWEEN '{$fechaI}' and '{$fechaF}' 
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.idLinea = {$linea} AND c.turno = 1 and t.tipo = 'Perdida' and c.fecha BETWEEN '{$fechaI}' and '{$fechaF}' 
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
         ...
         if($linea == 0){
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.turno = 2 and t.tipo = 'Perdida' and c.fecha BETWEEN '{$fechaI}' and '{$fechaF}' 
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
        ...
        $sql=$mysqli->query("SELECT ca.tipoCausa as Causa, sum(dc.numPiezas) as Piezas,"
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.idLinea = {$linea} AND c.turno = 2 and t.tipo = 'Perdida' and c.fecha BETWEEN '{$fechaI}' and '{$fechaF}' 
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
        ...
        if($linea == 0){
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.turno = 3 and t.tipo = 'Perdida' and c.fecha BETWEEN '{$fechaI}' and '{$fechaF}' 
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
        ...
        $sql=$mysqli->query("SELECT ca.tipoCausa as Causa, sum(dc.numPiezas) as Piezas,"
           ...
           /* Getting demo_viewer table data */
            $sql = "Select sum(dc.numPiezas) as co FROM detallecalidad as dc 
                ...
                INNER JOIN causa as ca ON dc.idCausa = ca.idCausa 
                INNER JOIN disenio as d ON c.idDisenio=d.idDisenio 
                WHERE c.idLinea = {$linea} AND c.turno = 3 and t.tipo = 'Perdida' and c.fecha BETWEEN '{$fechaI}' and '{$fechaF}' 
                group by ca.tipoCausa ORDER BY co DESC LIMIT 10";
