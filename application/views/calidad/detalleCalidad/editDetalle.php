            ...
            <section class="modal-header">
                <form style="width: 100%;" method="POST" action="<?php echo site_url('/detalle/lis') ?>">
                    ...
                    <div class="">
                        ...
                        <div class="input-group"> 
                            <label for="turno">Defecto</label> <br>
                            <input type="number" class="form-control" name="idDetalle" value="<?php echo $cal->idDetalle; ?>">
                        </div>
                        <div class="input-group"> 
                            <label for="turno">Calidad</label> <br>
                            <input type="number" class="form-control" name="idDetalle" value="<?php echo $cal->idCalidad; ?>">
                ...
                <center><label> ¡¡Está seguro de eliminar el defecto de calidad!! Esto ocasionara que se pierdan los <?php echo $cal->idDetalle;?>
                        datos.</label></center>
            </section>
            <center>
