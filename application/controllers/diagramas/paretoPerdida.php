 ...
 * @author Diego
 */
class paretoPerdida extends CI_Controller {
        ...
        if($this->session->userdata('perfil') == FALSE || 
			...
			redirect(base_url().'login');  
                        ...
                        $this->load->view('/templates/header', $data);
                         $this->load->view('/templateFiltro/filtroPerdida.php', $data);
                        $this->load->view('/pareto/perdida.php', $data);
    ...
    function pareto(){
        if($this->session->userdata('perfil') == FALSE || 
                ...
                redirect(base_url().'login','refresh');
                    ...
                    $this->load->view('/templates/header', $data);
                    $this->load->view('/templateFiltro/filtroPerdida.php', $data);
                    $this->load->view('/pareto/perdidaF.php', $data);
                    $this->load->view('templates/copyright',$data);
                }           
    }
}
