...
/**
 * Description of paretoRechazo
 *
 * @author Diego
 */
class paretoRechazo extends CI_Controller{
    var $base;
    var $css;
        ...
        if($this->session->userdata('perfil') == FALSE || 
			...
			redirect(base_url().'login');  
                        ...
                        $this->load->view('/templates/header', $data);
                         $this->load->view('/templateFiltro/filtroRechazo.php', $data);
                        $this->load->view('/pareto/rechazo.php', $data);
    ...
    function pareto(){
        if($this->session->userdata('perfil') == FALSE || 
                ...
                redirect(base_url().'login','refresh');
                    ...
                    $this->load->view('/templates/header', $data);
                    $this->load->view('/templateFiltro/filtroRechazo.php', $data);
                    $this->load->view('/pareto/rechazoF.php', $data);
                    $this->load->view('templates/copyright',$data);
                }           
    }
}
