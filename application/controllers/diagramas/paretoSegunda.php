...
/**
 * Description of paretoPerdida
 *
 * @author Diego
 */
class paretoSegunda extends CI_Controller {
        ...
        if($this->session->userdata('perfil') == FALSE || 
			...
			redirect(base_url().'login');  
                        ...
                        $this->load->view('/templates/header', $data);
                         $this->load->view('/templateFiltro/filtroSegunda.php', $data);
                        $this->load->view('/pareto/segunda.php', $data);
    ...
    function pareto(){
        if($this->session->userdata('perfil') == FALSE || 
                ...
                redirect(base_url().'login','refresh');
                    ...
                    $this->load->view('/templates/header', $data);
                    $this->load->view('/templateFiltro/filtroSegunda.php', $data);
                    $this->load->view('/pareto/segundaF.php', $data);
                    $this->load->view('templates/copyright',$data);
                }           
    }
}
