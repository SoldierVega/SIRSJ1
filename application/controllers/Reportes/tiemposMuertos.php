...
class tiemposMuertos extends CI_Controller{
    ...
    $turnos=  ExcelClass::turnosTiempoMuerto($fechaReporte);
       $totalSuma1=0;
        $totalSuma2=0;
        $totalSuma3=0;
        $totalSuma4=0;
    ...
    foreach ($turnos as $key => $turno) {
        ...
        $tipoParo=  ExcelClass::NombreParoTurno($turno,$fechaReporte);
        $sumTotalL1=0;
        $sumTotalL2=0;
        $sumTotalL3=0;
        $sumTotalL4=0;
        ...
        foreach ($tipoParo as $key => $paro) {
            $lineasTM = ExcelClass::LineasTiempoMuerto($turno, $key, $fechaReporte);
